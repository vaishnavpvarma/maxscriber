...
workspace_root = get_platform_path(r"d:\DENV_Genome_WGS\MaxScriber_Py\Lab_Report_Samples\Max_Scriber_Tool_2_Repo_KFT_Location")
sys.path.insert(0, str(workspace_root))

from maxscriber.pipeline import run_all_phase1, run_all_phase2

input_dir = get_platform_path(r"D:\DENV_Genome_WGS\Meta_Data\Dengue_2023_data\Dengue_clinical_reports_2023_corrected\All_PDFs_2023")
