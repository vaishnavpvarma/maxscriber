...
TEST_ALIASES = {
    ...
    # =========================================================================
    'Urea': [
        'urea', 'blood urea', 'serum urea', 'urea serum', 'urea nitrogen',
        'urea urease gldh', 'urea urease uv', 'urea enzymatic rate', 'urea urease',
        'urea urase uv', 'urea urease with indicator dye',
    ],
    'BUN': [
        'bun', 'blood urea nitrogen', 'b.u.n', 'b.u.n.', 'bun blood urea nitrogen',
        'blood urea nitrogen urease gldh', 'blood urea nitrogen urease uv',
        'blood urea nitrogen enzymatic rate', 'blood urea nitrogen calculated',
        'blood urea nitrogen urease with indicator dye',
    ],
    'Creatinine': [
        'creatinine', 's. creatinine', 'serum creatinine', 'creatinine serum',
        'creatinine, serum', 'creatinine, serum*',
        'creatinine jaffe kinetic', 'creatinine rate-jaffe', 'creatinine rate jaffe',
        'creatinine alkaline picrate kinetic', 'creatinine alkaline picrate',
        'creatinine enzymatic', 'creatinine enzymatic creatinine amidohydrolase',
        'creatinine uricase', 'creatinine modified jaffe',
    ],
    'BUN_Creatinine_Ratio': [
        'bun/creatinine ratio', 'bun creatinine ratio', 'bun/creatinine',
        'blood urea nitrogen/creatinine ratio',
    ],
    'Uric_Acid': [
        'uric acid', 's. uric acid', 'serum uric acid', 'uric acid serum',
        'uric acid, serum', 'uric acid, serum*',
        'uric acid uricase colorimetric', 'uric acid uricase peroxidase',
        'uric acid uricase', 'uric acid enzymatic',
    ],
    'eGFR': [
        'egfr', 'e-gfr', 'egfr by mdrd', 'egfr mdrd', 'egfr by ckd epi',
        'egfr by ckd epi 2021', 'egfr ckd epi', 'egfr ckd-epi',
        'glomerular filtration rate', 'estimated glomerular filtration rate',
        'gfr mdrd', 'gfr ckd epi',
    ],
}
...
KFT_TESTS = {
    'Urea', 'BUN', 'Creatinine', 'BUN_Creatinine_Ratio', 'Uric_Acid', 'eGFR'
}
...
KFT_NOISE_PREFIXES = (
    'ref. range', 'ref range', 'reference range',
    'comment', 'comments', 'note:', 'notes:',
    'interpretation', 'advice', 'advise',
    'kindly correlate', '*** end',
)
...
OUTPUT_COLUMNS = [
    'MAX_id', 'Centre', 'Tests Done', 'File Name', 'SIN No.', 'Gender', 'Age', 'Collection_date'
]
