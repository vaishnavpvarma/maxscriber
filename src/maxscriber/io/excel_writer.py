...
from maxscriber.config import OUTPUT_COLUMNS, CBC_TESTS, LFT_TESTS, KFT_TESTS, DENGUE_TESTS, TEST_ALIASES
...
def generate_excel_report(data: dict, output_dir: Path, logger, pattern: str = '2024_2025', job_name: str = 'default'):
...
def generate_longitudinal_excel(patient_data: Dict, longitudinal_tests: Dict, output_path: Path, logger):
